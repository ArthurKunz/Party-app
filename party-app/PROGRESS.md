...
In this file you will see what features are done and what we still have implement. 
...
- Sign up / log in with email (Supabase Auth, middleware.ts in place, session working)